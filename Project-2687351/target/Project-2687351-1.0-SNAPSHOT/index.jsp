...
<head>
    ...
    <!-- desccripcion -->
    <meta name="descripcion" content="Este es el un formulario de registro ">
    <!--Keywords/palabras clave-->
    <meta name="keywords"content="Login, formulario, formulario de registro,Registro de usuario, crear cuenta">
